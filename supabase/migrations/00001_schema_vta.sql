...
create table public.alberi (
  ...
  radici                          jsonb not null default '{"difetti": [], "gravita": 0}',
  fusto                           jsonb not null default '{"difetti": [], "gravita": 0}',
  chioma                          jsonb not null default '{"difetti": [], "gravita": 0}',
  note_osservazioni               text,
  cpc                             text not null check (cpc in ('A', 'B', 'C', 'D')),
