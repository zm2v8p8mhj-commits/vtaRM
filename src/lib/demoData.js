...
export const ALBERI_DEMO = [
  ...
  albero({
    ...
    radici: { difetti: ['Radici affioranti danneggiate', 'Asfissia radicale / pavimentazione'], gravita: 2 },
    fusto: { difetti: ['Inclinazione anomala'], gravita: 2 },
    chioma: { difetti: ['Branche morte'], gravita: 2 },
  ...
  albero({
    ...
    fusto: { difetti: ['Cavità', 'Carie / legno degradato', 'Carpofori'], gravita: 4 },
    chioma: { difetti: ['Branche morte', 'Sbrancature'], gravita: 3 },
  ...
  albero({
    ...
    chioma: { difetti: ['Branche codominanti', 'Inserzioni deboli / corteccia inclusa'], gravita: 1 },
  ...
  albero({
    ...
    fusto: { difetti: ['Ferite / lesioni corticali'], gravita: 1 },
  ...
  albero({
    ...
    fusto: { difetti: ['Inclinazione anomala', 'Fessurazioni / cretti'], gravita: 3 },
    radici: { difetti: ['Sollevamento del terreno'], gravita: 3 },
  ...
  albero({
    ...
    fase_sviluppo: 'Maturo', cpc: 'B',
    chioma: { difetti: ['Seccume diffuso'], gravita: 1 },
  ...
  albero({
    ...
    fusto: { difetti: ['Capitozzatura pregressa', 'Carie / legno degradato'], gravita: 4 },
