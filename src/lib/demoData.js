...
export const ALBERI_DEMO = [
  ...
  albero({
    ...
    radici: { difetti: ['Radici affioranti danneggiate', 'Asfissia radicale / pavimentazione'], gravita: 3 },
  ...
  albero({
    ...
    fusto: { difetti: ['Cavità', 'Carie / legno degradato', 'Carpofori'], gravita: 5 },
    chioma: { difetti: ['Branche morte', 'Sbrancature'], gravita: 4 },
  ...
  albero({
    ...
    chioma: { difetti: ['Branche codominanti', 'Inserzioni deboli / corteccia inclusa'], gravita: 2 },
  ...
  albero({
    ...
    fusto: { difetti: ['Ferite / lesioni corticali'], gravita: 2 },
  ...
  albero({
    ...
    fase_sviluppo: 'Maturo', cpc: 'B',
    chioma: { difetti: ['Seccume diffuso'], gravita: 2 },
